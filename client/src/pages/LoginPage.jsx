      ...
      >
        ...
        <div>
          ...
          <p className="text-white/75 text-lg leading-relaxed font-sans-dm max-w-sm">
            Discover the incredible diversity of India — from snow-capped
            Himalayas to golden beaches — all AI-planned, just for you.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-xs text-[#386FA4] font-semibold hover:underline font-sans-dm"
                >
                  Forgot password?
                </a>
              </div>
