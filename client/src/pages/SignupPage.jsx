    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="text-white/75 text-lg leading-relaxed font-sans-dm max-w-sm">
            Join thousands of travellers who use YatraAI to discover, plan, and experience the real India.
          </p>
        </div>

        <p className="text-white/40 text-xs font-sans-dm">© 2025 YatraAI · All rights reserved</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        ...
        >
          ...
          <h1 className="font-display font-black text-[#133C55] text-3xl mb-2">Create account</h1>
          <p className="text-[#133C55]/60 text-sm font-sans-dm mb-8">
            Already have an account?{" "}
            <Link to="/login" className="text-[#386FA4] font-bold hover:underline">
              Sign in
            </Link>
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="signup-name" className="text-xs font-bold tracking-widest uppercase text-[#133C55]/70 font-sans-dm">
                Full name
              </label>
              <div className="relative">
                <User size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-[#386FA4]" />
                <input
                  id="signup-name"
                  type="text"
                  autoComplete="name"
                  ...
                  style={{ background: "#fff", border: "1.5px solid #d0e8f5", boxShadow: "0 2px 8px rgba(56,111,164,0.06)" }}
            ...
            {/* Email */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="signup-email" className="text-xs font-bold tracking-widest uppercase text-[#133C55]/70 font-sans-dm">
                Email address
              </label>
              <div className="relative">
            ...
            {/* Password */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="signup-password" className="text-xs font-bold tracking-widest uppercase text-[#133C55]/70 font-sans-dm">
                Password
              </label>
              <div className="relative">
            ...
            <p className="text-xs text-[#133C55]/50 font-sans-dm -mt-1">
              ...
              <a href="#" className="text-[#386FA4] hover:underline">Terms of Service</a>
              {" "}and{" "}
              <a href="#" className="text-[#386FA4] hover:underline">Privacy Policy</a>.
            </p>
