...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-10" style={{ background: "#eef7fc" }}>
      ...
      <div className="w-full max-w-5xl rounded-3xl overflow-hidden shadow-2xl flex flex-col lg:flex-row bg-white">
        ...
        <div className="flex-1 bg-white relative flex items-center justify-center px-6 sm:px-10 py-8 overflow-hidden">
          ...
          <div className="absolute top-6 right-6 pointer-events-none opacity-0">
            <div className="grid gap-[7px]" style={{ gridTemplateColumns: "repeat(7, 1fr)" }}>
              {Array.from({ length: 35 }).map((_, i) => (
                <div key={i} className="w-1.5 h-1.5 rounded-full" style={{ background: "#14b8a6", opacity: 0.18 }} />
              ))}
            </div>
          </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
                ...
                <div className="flex flex-col gap-1">
                  <label htmlFor="signup-name" className="text-xs font-semibold text-[#133C55]/75">
                    Your name
                  </label>
                ...
                {/* Email */}
                <div className="flex flex-col gap-1">
                  <label htmlFor="signup-email" className="text-xs font-semibold text-[#133C55]/75">
                    Your Email
                  </label>
                  <div className="relative">
                ...
                {/* Create Password */}
                <div className="flex flex-col gap-1">
                  <label htmlFor="signup-password" className="text-xs font-semibold text-[#133C55]/75">
                    Create Password
                  </label>
                  <div className="relative">
                ...
                {/* Repeat Password */}
                <div className="flex flex-col gap-1">
                  <label htmlFor="signup-repeat" className="text-xs font-semibold text-[#133C55]/75">
                    Repeat password
                  </label>
                  <div className="relative">
                    <Lock size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#94a3b8]" />
                ...
                <motion.button
                  ...
                  style={{ background: "linear-gradient(135deg, #0f2442 0%, #1f3ccbff 100%)" }}
                >
                  <span>Sign up</span>
              ...
              <p className="text-center text-xs mt-4" style={{ color: "#94a3b8" }}>
                Already a Member?{" "}
                <Link to="/login" className="font-bold hover:underline" style={{ color: "#14b8a6" }}>
                  Sign in here
                </Link>
              </p>
            </motion.div>
