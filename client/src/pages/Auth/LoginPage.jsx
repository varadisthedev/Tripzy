            ...
            >
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <label htmlFor="login-email" className="text-xs font-semibold text-[#133C55]/75">
                    Your Email
                  </label>
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex items-center justify-between">
                    <label htmlFor="login-password" className="text-xs font-semibold text-[#133C55]/75">
                      Password
                    </label>
                    <a href="#" className="text-xs font-semibold hover:underline" style={{ color: "#14b8a6" }}>
                      Forgot password?
                    </a>
                  </div>
                  <div className="relative">
              ...
              <p className="text-center text-xs mt-5" style={{ color: "#94a3b8" }}>
                ...
                <Link to="/signup" className="font-bold hover:underline" style={{ color: "#14b8a6" }}>
                  Sign up here
                </Link>
              </p>
            </motion.div>
